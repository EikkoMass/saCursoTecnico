...
<link rel="stylesheet" href="../css/ordensServicoGer.css">
...
<h2>Ordem de Serviço</h2>
    <form method="GET" action="ordensServicoGer.php">
                      ...
                      <?php
                        ...
                        if(isset($_GET['buscaNome'])==false){
                          ...
                          $resultado = mysqli_query($conexao,$comando);
                              ...
                              <td class="tdborder"> <?php if($cadaGeral['status']==1){
                                echo "Em Andamento";
                              ...
                              <td class="tdborder">
                                  <form action="../php/editaOrdem.php" method="GET" class="formato" id="editarForm1">
                                      <input type="hidden" value="<?php echo $cadaGeral['id'];?>" name="idVi" >
                                  <button type="submit" class="visualizar"><img src="../img/iconsSistema/miniEditar2.png" alt="Editar Conteúdo" id="editar1" class="icons"></button>

                                </form>
                                	<form action="visualizarOrdemGer.php" method="GET">
                                    <input type="hidden" value="<?php echo $cadaGeral['id'];?>" name="idVi" >
