...
<div id="conteudo">
  ...
  <form action="../php/registraCliente.php" method="POST" onsubmit="return registraClientes()">
...
<?php
	if(isset($_GET['retorno'])==true){
		if($_GET['retorno']==1){
			...
			include("../alertas/erroRegistro.html");
		}
	}
...
<br>
      ...
      <option value="" selected()>Selecione</option>
        <option value="pf" id="selecionaPF">Pessoa Física</option>
        <option value="pj"  id="selecionaPJ">Pessoa Juridica</option>
      ...
      if($linhas==0){		?>
        <tr>
          ...
          <td class="tdborder">
            ...
            <form action="editaClienteForm.php" method="POST" class="formato" id="editaform2">
            ...
            <form action="../php/excluiCliente.php" method="POST" class="formato" id="apagaform2" onSubmit="return confirma()">
            <input type="hidden" name="idCliente" value="<?php echo $cadaCliente['id'];?>">
                <button type="submit" class="buttonApagar"><img src="../img/iconsSistema/miniApagar.png" alt="Apagar conteúdo" id="apagar2" class="icons"></button>
            </form>
          </td>
