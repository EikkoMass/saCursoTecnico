...
function nivelaData($dating){
  return date('d/m/Y', strtotime($dating));
}
...
<header>
  ...
  <br><br><a href="../paginasSistema/orcamento.php"><p id="voltar">Voltar</p></a>
</header>
<main>
...
<?php
    ...
    ?>
    <option selected="selected" value="<?=$cadaCliente['id'];?>"><?=$cadaCliente['nome']; ?>
    </option>
    <?php
   }
   else{
...
<button type="submit" id="registrar">Registrar</button>
  <input type="text" name="valorTotal" id="valorTotal" value="<?=$tudoOrcamento['preco_total'];?>" step="any" readonly="readonly"  class="textbox" onchange="evitaErro()">
</div>
